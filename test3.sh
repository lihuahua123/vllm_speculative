...
NUM_PROMPTS=200
PROMPT_RATE=5
FILE_NAME=medusa3.log # 
SPECULATIVE_LEN=2
START_INDEX=0
ENABLE_TRACE="False"
SAVE_TRACE="False"
num_gpu_blocks_override=717 #717 #26064 #9369 #A600 50% #4800 4090 # deep A6000 26064 llama8b A6000 xxx  通过下面命令行得到 788 for 33B vicuna and eagle 1285 for 13B vicuna and eagle
...
model_name=/root/autodl-tmp/vicuna-13b-v1.3 #/root/autodl-tmp/vicuna-13b-v1.3  #/model/vicuna-7b-v1.3
draft_model_name=/root/autodl-tmp/vicuna-68m #/root/autodl-tmp/vllm-medusa-vicuna-7b-v1.3 #/root/autodl-tmp/vicuna-68m #/root/autodl-tmp/vllm-medusa-vicuna-7b-v1.3
...
for i in 1 # 2 3 4 5
do
    for PROMPT_RATE in  400 #5 10 15 20 25 #25 # 24 # 6 8 10 12 14 # 10 15 # 20 25 #0.5 2 5 10
    do
        ...
        # sleep 3
        #Nightjar
        # python run_benchmark_tests.py --strategy ilp --sub-strategy epsilon_greedy --explore $explore --save-trace $SAVE_TRACE --model $model_name --draft-model $draft_model_name       --dataset-name $data_set_name         --dataset-path $data_set_path   --speculative-len 5 --num-prompts $NUM_PROMPTS --request-rate $PROMPT_RATE --start-index $START_INDEX --num-gpu-blocks-override $num_gpu_blocks_override --enable-trace "$ENABLE_TRACE" --burstiness $burstiness --gpu-memory-utilization $gpu_memory_utilization &>> $FILE_NAME
