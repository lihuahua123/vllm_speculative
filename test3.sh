...
NUM_PROMPTS=480
PROMPT_RATE=10   
FILE_NAME=staticrequestspecbench_480qsmart3_tiaojiao3.log #  134 是100 sharegpt 136 是 $NUM_PROMPTS sharegpt
SPECULATIVE_LEN=5
START_INDEX=0
ENABLE_TRACE="False"
num_gpu_blocks_override=9369 #26064 #9369 #A600 50% #4800 4090 # deep A6000 26064 llama8b A6000 xxx  通过下面命令行得到
...
# START_INDEX=500
# ENABLE_TRACE="False"
# num_gpu_blocks_override=28000 #26064 # deep A6000 26064 llama8b A6000 11466  通过下面命令行得到
...
# rm -rf $FILE_NAME
# data_set_name=alpaca    #--dataset-path tatsu-lab/alpaca
# data_set_path=tatsu-lab/alpaca # $data_set_path
# model_name=/root/autodl-tmp/deepseek 
# model_name=/data/model/deepseek-aiDeepSeek-R1-Distill-Qwen-7B
# draft_model_name=/data/model/DeepSeek-R1-DRAFT-Qwen2.5-0.5B
