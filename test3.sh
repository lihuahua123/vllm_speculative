...
NUM_PROMPTS=500
PROMPT_RATE=10   
FILE_NAME=azureqps_minus15_200tiaojiao.log #  134 是100 sharegpt 136 是 300 sharegpt
SPECULATIVE_LEN=5
START_INDEX=300
ENABLE_TRACE=True
num_gpu_blocks_override=26064 # deep A6000 26064 llama8b A6000 11466  通过下面命令行得到
...
# for PROMPT_RATE in 10 15 #0.5 2 5 10
# do
