...
from vllm import LLM, SamplingParams, Device
...
def collect_prefill_performance_stats(
    ...
    for batch_size in tqdm(batch_sizes, desc="测试不同batch大小"):
        ...
        if len(requests) < batch_size:
            continue
        llm.reset_prefix_cache(Device.CUDA)
        ...
        if not is_small_model:
            ...
            performance_stats.append({
                ...
                "num_new_prefill_tokens": spec_len * batch_size,
            ...
            performance_stats.append({
                ...
                "spec_len": spec_len,
                "total_prompt_tokens": total_prompt_tokens1,
                "num_new_prefill_tokens": 1 * batch_size,
...
def main():
    ...
    output_path = "vllm_prefill_perf_stats.json"
